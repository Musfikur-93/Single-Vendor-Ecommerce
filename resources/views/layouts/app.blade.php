									...
									<li>
										...
										<ul style="width:300px; padding: 10px;">
											<div>
												...
												<div class="form-group">
														<a href="" class="btn btn-danger btn-block text-white">Login with google</a>
												</div>
											</div>
										</ul>
									</li>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo">
								<a href="{{url('/')}}"><img src="{{ asset($setting->logo) }}" style="height: 60px;"></a>
								<!-- <a href="{{ url('/') }}">ABCMart</a> -->
							</div>
						</div>
					</div>
						...
						<div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									<div class="cart_icon">
										<img src="{{ asset('public/frontend') }}/images/cart.png" alt="cart">
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_column footer_contact">
						<div class="logo_container">
							<div class="logo">
								<img src="{{ asset($setting->logo) }}" style="height: 60px;">
								<!-- <a href="{{ url('/') }}">ABCMart</a> -->
							</div>
						</div>
