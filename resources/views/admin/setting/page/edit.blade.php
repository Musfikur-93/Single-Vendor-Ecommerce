              ...
              <form role="form" action="{{ route('page.update',$page->id) }}" method="post">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="exampleInputPassword3">Page Position</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="page_name" id="exampleInputEmail1" placeholder="Page Name" value="{{ $page->page_name }}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword2">Page Title</label>
                        <input type="text" class="form-control" name="page_title" id="exampleInputPassword2" placeholder="Page Title" value="{{ $page->page_title }}">
                    </div>
                    <div class="form-group">
