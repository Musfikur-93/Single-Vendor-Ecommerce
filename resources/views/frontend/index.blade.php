...
<div class="banner">
  ...
  <div class="container fill_height">
    <div class="row fill_height">
      <div class="banner_product_image"><img src="{{ asset('public/files/product/'.$bannerproduct->thumbnail) }}" alt="{{ $bannerproduct->product_name }}"></div>
...
<!-- Campaing show on front page -->
@isset($campaing)
<div class="characteristics">
  <div class="container">
    <div class="row">
      <h4>{{$campaing->title}}</h4>
        <div class="col-lg-12 char_col">
          <div class="brands_item">
            <a href="#"><img src="{{ $campaing->image }}" alt="{{ $campaing->title }}" height="100%" width="100%"></a>
          </div>
        </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      @foreach($brand as $row)
        <div class="col-lg-1 col-md-6 char_col" style="border: 1px solid gray; padding: 5px;">
          <div class="brands_item">
            <a href="{{ route('brandwise.product', $row->id) }}" title="{{ $row->brand_name }}"><img src="{{ asset( $row->brand_logo ) }}" alt="{{ $row->brand_name }}" height="100%" width="100%"></a>
          </div>
        </div>
        @endforeach

      <!-- Char. Item -->
      <!-- <div class="col-lg-1 col-md-6 char_col">
          ...
          <div class="deals_slider_container">
            ...
            <div class="owl-carousel owl-theme deals_slider">
              ...
              <div class="owl-item deals_item">
                <div class="deals_image"><img src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt="{{ $row->product_name }}"></div>
                    ...
                    <div class="deals_item_category"><a href="#">{{ $row->subcategory->subcategory_name }}</a></div>
                      @if($row->discount_price==NULL)
                        ...
                        <div class="deals_item_price ml-auto">
                          <span class="text-danger">{{ $setting->currency }} {{$row->discount_price}}</span>
                        </div>
                      @endif
                  </div>
                  <div class="deals_info_line d-flex flex-row justify-content-start">
                    <div class="deals_item_name">
                      <a href="{{ route('product.details',$row->slug) }}">{{ substr($row->product_name, 0,25) }}</a>
                    </div>
                  </div>
                  <div class="available">
              ...
              <div class="featured_slider slider">
                ...
                <div class="featured_slider_item">
                  ...
                  <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt="{{ $row->product_name }}" height="100%" width="80%"></div>
                    <div class="product_content">
                      ...
                      <div class="product_name">
                         <a href="{{ route('product.details',$row->slug) }}">{{ substr($row->product_name, 0,20) }}..</a></div>
                      <div class="product_extras">
                        <div class="product_color">
                            <a href="#" class="quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModalCenter">quick view</a>
                        </div>
                        <button class="product_cart_button quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModalCenter">Choose and Add Cart</button>
                      </div>
                    </div>
          ...
          <div class="owl-carousel owl-theme popular_categories_slider">
            ...
            <div class="owl-item">
              <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                <div class="popular_category_image"><img src="{{ asset($row->icon) }}" alt="{{ $row->icon }}" height="100%" width="80%"></div>
                <div class="popular_category_text">
                  <a href="{{ route('categorywise.product', $row->id) }}">{{ substr($row->category_name, 0,15) }}..</a>
                </div>
              </div>
            </div>
            @endforeach
...
<!-- Homepage category wise product show -->
                                  ...
                                  @foreach($cat_product as $row)
                                    ...
                                    <div class="arrivals_slider_item">
                                        ...
                                        <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt="{{ $row->product_name }}" height="100%" width="50%"></div>
                                            <div class="product_content">
                                                <div class="product_price">
                                                    @if($row->discount_price==NULL)
                                                      ...
                                                      @else
                                                      <div class="product_price discount">
                                                        {{ $setting->currency }} {{$row->discount_price}}-<del class="text-muted">{{ $setting->currency }} {{$row->selling_price}}</del>
                                                      </div>
                                                    @endif
                                                </div>
                                                <div class="product_name"><div><a href="{{ route('product.details',$row->slug) }}">{{ substr($row->product_name, 0,20) }}..</a></div></div>
                                                <div class="product_extras">
                                                    <div class="product_color">
                                                        <a href="" class="quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModalCenter">quick view</a>
                                                    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <div class="trends_container">
          ...
          <div class="trends_text"><p>This year best treandy product.</p></div>
          ...
          <div class="owl-carousel owl-theme trends_slider">
            ...
            <div class="owl-item">
              <div class="trends_item is_new">
                <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('public/files/product/'.$row->thumbnail) }}" alt="{{ $row->product_name }}"></div>

                <div class="trends_price">
                  @if($row->discount_price==NULL)
                    {{ $setting->currency }}{{ $row->selling_price }}
                    @else
                      {{$setting->currency}} {{$row->discount_price}}-<del class="text-danger">{{ $setting->currency }} {{ $row->selling_price }}</del>
                  @endif
                </div>
                ...
                <div class="trends_content">
                  ...
                  <div class="trends_info clearfix">
                    <div class="trends_name"><a href="{{ route('product.details', $row->slug) }}">{{ substr($row->product_name, 0, 15) }}..</a></div>
                  </div>
                </div>

                <a href="#" class="quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModalCenter">
          ...
          <div class="owl-carousel owl-theme reviews_slider">
            ...
            <div class="owl-item">
              <div class="review d-flex flex-row align-items-start justify-content-start">
                <div><div class="review_image"><img src="{{ asset('public/files/wbreviews/dummy.jpg') }}" alt=""></div></div>
      ...
      <div class="col">
        <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
          ...
          <div class="newsletter_content clearfix">
            <form action="{{ route('store.newsletter') }}" method="post" id="newsletter_form" class="newsletter_form">
              @csrf
